...
public class Application {
	...
	public static void main(String[] args) {
		...
		KlassenroosterController klassenRoosterController = new KlassenroosterController(infoSysteem);
		...
		server.registerHandler("/klassenrooster/rooster", klassenRoosterController);
